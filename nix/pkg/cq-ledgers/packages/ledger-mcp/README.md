...
| `finalize_implementation_review_attempt` | `purpose-built-small` | Exactly `{ status, attemptRef, terminalState, outcome }`; `outcome` is either the validated reviewer verdict or an authenticated operational abstention. |
