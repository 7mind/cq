...
export const POST_TARGET_ADDITIONS: readonly ToolDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ["action_id", "expected_revision", "output_identity", "acknowledged_at"],
      additionalProperties: false,
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ["action_id", "expected_revision", "completion", "author"],
      additionalProperties: false,
    },
  },
  {
  ...
  },
  {
    ...
    description:
      "Return the validated outcome.\n\nAuthoritative response: `{status,attemptRef,terminalState,outcome}`.",
    inputSchema: {
      type: "object",
      properties: {
        attempt_ref: {
