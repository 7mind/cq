...
export const USAGE = [
  ...
  "                                                  opaque CQ_GUARDED_REBASE_REFERENCE. The",
  "                                                  implement flow retains that reference as",
  "                                                  the sole rebase authority and passes it",
  "                                                  verbatim with the exact reprepareOf handle",
