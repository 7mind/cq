...
export const EXPECTED_FAILURE_INVENTORY: readonly ExpectedFailureInventoryEntry[] = [
  ...
  {
    file: "nix/pkg/cq-ledgers/packages/ledger/test/sqlite-plan-lifecycle-scaling.test.ts",
    title: "sqlite plan lifecycle uses keyed row plans",
    ledgerRef: "tasks:T5542",
  },
];
