...
export const EXPECTED_FAILURE_INVENTORY: readonly ExpectedFailureInventoryEntry[] = [
  ...
  {
    file: "nix/pkg/cq-ledgers/packages/ledger/test/postgres-direct-owned-lifecycle-scaling.test.ts",
    title: "postgres direct owned lifecycle consumers use keyed row plans",
    ledgerRef: "tasks:T5921",
  },
];
