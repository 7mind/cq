...
export const EXPECTED_FAILURE_INVENTORY: readonly ExpectedFailureInventoryEntry[] = [
  ...
  {
    file: "nix/pkg/cq-ledgers/packages/ledger/test/postgres-owned-lifecycle-scaling.test.ts",
    title: "postgres admitted owned lifecycle uses keyed rows",
    ledgerRef: "tasks:T5920",
  },
];
