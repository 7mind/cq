...
export const EXPECTED_FAILURE_INVENTORY: readonly ExpectedFailureInventoryEntry[] = [
  ...
  {
    file: "nix/pkg/cq-ledgers/packages/ledger/test/sqlite-operator-action-lifecycle-scaling.test.ts",
    title: "sqlite operator-action lifecycle uses keyed row plans",
    ledgerRef: "tasks:T5543",
  },
];
