> **Subagent dispatch (Pi).** `CQ_SUBAGENT` means CQ-driven dispatch: CQ
...
>
> Never launch a CQ role with `dispatch_agent`; CQ launches Pi-targeted roles
> and settles their fenced results itself.
