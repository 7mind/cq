 ...
 * not "forward progress" for the stall detector. `goalDrift` (G84/D113) and
 * `planBusy` (G99/D134, T853) are EXCLUDED for the same reason: both are
 * report-only, so a drift-only or busy-only delta must NOT count as forward
 * progress either.
 */
