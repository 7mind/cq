...
buildNpmPackage (finalAttrs: {
  ...
  # a network fetch and is gitignored upstream. Restore it from the matching
  ...
  # Invoke tsgo directly for workspace deps to skip pi-ai's generate-models
  # script (network); the catalog is supplied via modelData above.
  buildPhase = ''
    runHook preBuild
