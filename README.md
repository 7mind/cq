...
| `@cq/ledger-mcp` | Standalone MCP server exposing the 57-tool ledger surface over **stdio** or **Streamable HTTP**. |
...
The 57-tool ledger surface uses a single breaking wire-response contract:
